...
# Set the working directory to the package to ensure relative paths work correctly
os.chdir(os.path.join(script_dir, 'coverletter_wiz'))

# Import from the package
from coverletter_wiz.cli.rate_content import main as rate_content_main
from coverletter_wiz.cli.analyze_job import main as analyze_job_main
from coverletter_wiz.cli.match_content import main as match_content_main
from coverletter_wiz.cli.process_text import main as process_text_main
